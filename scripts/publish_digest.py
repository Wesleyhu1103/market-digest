...
ARCHIVE_LOCAL_ASSET_RE = re.compile(r'((?:src|href)=")(js/[^"]+|css/[^"]+)(")')
...
def archive_safe_asset_paths(html: str) -> str:
    """Rewrite root-relative site assets for snapshots stored under docs/archive/."""
    return ARCHIVE_LOCAL_ASSET_RE.sub(r"\1../\2\3", html)
