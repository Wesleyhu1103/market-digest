...
def archive_safe_html(html: str) -> str:
    """Rewrite root-level digest asset links for pages saved under docs/archive/."""
    html = re.sub(r'((?:src|href)=["\'])(js|css)/', r"\1../\2/", html)
    return html
...
def archive_previous_day(current_html: str, today_iso: str) -> None:
    ...
    if not snapshot_path.exists():
        ...
        snapshot = archive_safe_html(snapshot)
