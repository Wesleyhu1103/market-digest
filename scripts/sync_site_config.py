...
# Matches local asset references (src="js/…" / href="css/…", or archive-safe
# "../js/…" / "../css/…") carrying a ?v=<digits> cache-bust. Leaves CDN URLs
...
def html_files() -> Iterable[Path]:
    ...
    if archive_dir.exists():
        yield from sorted(archive_dir.glob("*.html"))
