...
class SyncSiteConfigTests(unittest.TestCase):
    def test_sync_html_versions_updates_externalized_archive_assets(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            (archive / "2026-09-22.html").write_text(
                '<script src="../js/app.js?v=1"></script>'
                '<link rel="stylesheet" href="../css/digest.css?v=1">'
            )

            module.ROOT = root
            module.sync_html_versions("20260923")

            self.assertIn("?v=20260923", (docs / "index.html").read_text())
            self.assertIn("?v=20260923", (docs / "admin.html").read_text())
            archive_html = (archive / "2026-09-22.html").read_text()
            self.assertIn('src="../js/app.js?v=20260923"', archive_html)
            self.assertIn('href="../css/digest.css?v=20260923"', archive_html)
