...
class SyncSiteConfigTests(unittest.TestCase):
    def test_sync_html_versions_updates_live_admin_and_archives(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            (archive / "2026-08-20.html").write_text(
                '<script src="../js/config.js?v=1"></script>'
                '<link rel="stylesheet" href="../css/digest.css?v=1">'
            )

            module.ROOT = root
            module.sync_html_versions("20260821")

            self.assertIn("?v=20260821", (docs / "index.html").read_text())
            self.assertIn("?v=20260821", (docs / "admin.html").read_text())
            archive_html = (archive / "2026-08-20.html").read_text()
            self.assertIn('src="../js/config.js?v=20260821"', archive_html)
            self.assertIn('href="../css/digest.css?v=20260821"', archive_html)
